-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('open', 'closed', 'paused', 'expired');

-- CreateEnum
CREATE TYPE "AccountStatus" AS ENUM ('active', 'suspended');

-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('pending', 'reviewing', 'rejected', 'accepted', 'expired');
...
CREATE TABLE "CompanyCategory" (
    "company_category_id" SERIAL NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "CompanyCategory_pkey" PRIMARY KEY ("company_category_id")
);
