...
router.patch("/recruiter/:userId/jobs/:jobId/applications/:applicationId/reviewing", markApplicationAsReviewing);
router.patch("/recruiter/:userId/jobs/:jobId/applications/:applicationId/status", updateApplicationDecision);
